...
\led_test[3]_i_1\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
...
\led_test_reg[0]\: unisim.vcomponents.FDRE
     port map (
      C => s00_axi_aclk,
      CE => s00_axi_wvalid,
      D => s00_axi_wdata(0),
      Q => led_test(0),
      R => coproct_v1_0_S00_AXI_inst_n_1
    );
\led_test_reg[1]\: unisim.vcomponents.FDRE
     port map (
      C => s00_axi_aclk,
      CE => s00_axi_wvalid,
      D => s00_axi_wdata(1),
...
\led_test_reg[2]\: unisim.vcomponents.FDRE
     port map (
      C => s00_axi_aclk,
      CE => s00_axi_wvalid,
      D => s00_axi_wdata(2),
...
\led_test_reg[3]\: unisim.vcomponents.FDRE
     port map (
      C => s00_axi_aclk,
      CE => s00_axi_wvalid,
      D => s00_axi_wdata(3),
...
inst: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_coproct_v1_0
     port map (
      led_test(3 downto 0) => led_test(3 downto 0),
      s00_axi_aclk => s00_axi_aclk,
