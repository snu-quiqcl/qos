...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_coproct_v1_0_S00_AXI is
  ...
  signal sl_state_i_6_n_0 : STD_LOGIC;
  signal sl_state_i_7_n_0 : STD_LOGIC;
  signal sl_state_i_8_n_0 : STD_LOGIC;
  signal sl_state_i_9_n_0 : STD_LOGIC;
...
\out_buf[2]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
...
sl_state_i_1: unisim.vcomponents.LUT5
    generic map(
      INIT => X"5555D555"
    )
        port map (
...
sl_state_i_3: unisim.vcomponents.LUT5
    generic map(
      INIT => X"00000001"
    )
        port map (
...
sl_state_i_4: unisim.vcomponents.LUT5
    generic map(
      INIT => X"00000001"
    )
        port map (
...
sl_state_i_5: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFEFFFF"
    )
        port map (
...
sl_state_i_6: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
...
sl_state_i_7: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
...
sl_state_i_8: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
...
sl_state_i_9: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0001"
    )
        port map (
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix is
  ...
  signal \^out_test\ : STD_LOGIC_VECTOR ( 2 to 2 );
