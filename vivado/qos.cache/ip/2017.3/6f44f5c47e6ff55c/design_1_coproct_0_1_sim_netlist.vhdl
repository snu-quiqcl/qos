...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_coproct_v1_0_S00_AXI is
  ...
  attribute SOFT_HLUTNM of \out_buf[1]_i_1\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \out_buf[1]_i_3\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \out_buf[2]_i_1\ : label is "soft_lutpair1";
  ...
  attribute SOFT_HLUTNM of \slv_reg0_buf5[31]_i_4\ : label is "soft_lutpair0";
begin
...
\out_buf[1]_i_10\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
...
\out_buf[1]_i_2\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
...
sl_state_i_1: unisim.vcomponents.LUT4
    generic map(
      INIT => X"11F0"
    )
        port map (
...
sl_state_i_2: unisim.vcomponents.LUT6
    generic map(
...
\slv_reg0_buf5[31]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"B8"
    )
        port map (
...
\slv_reg0_buf5[31]_i_2\: unisim.vcomponents.LUT6
    generic map(
...
\slv_reg0_buf5[31]_i_3\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FBFF"
    )
        port map (
...
\slv_reg0_buf5[31]_i_4\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
...
\slv_reg0_buf5[31]_i_6\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"00000001"
    )
        port map (
...
\slv_reg0_buf5[31]_i_7\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFEFFFF"
    )
        port map (
...
\slv_reg0_buf5[31]_i_8\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"00000001"
    )
        port map (
