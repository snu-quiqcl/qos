...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_coproct_v1_0_S00_AXI is
  ...
  signal sl_state_i_3_n_0 : STD_LOGIC;
  signal sl_state_i_4_n_0 : STD_LOGIC;
  signal sl_state_i_5_n_0 : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \out_buf[1]_i_1\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \out_buf[2]_i_1\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of sl_state_i_2 : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of sl_state_i_5 : label is "soft_lutpair1";
  ...
  attribute SOFT_HLUTNM of \slv_reg0_buf5[31]_i_7\ : label is "soft_lutpair3";
begin
...
\out_buf[1]_i_4\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
...
\out_buf[1]_i_5\: unisim.vcomponents.LUT6
    generic map(
...
\out_buf[1]_i_9\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0001"
    )
        port map (
...
sl_state_i_2: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
...
sl_state_i_3: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFB"
    )
        port map (
...
sl_state_i_4: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FFFFFFFFFFFFFFFE"
    )
        port map (
...
sl_state_i_5: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
...
\slv_reg0_buf5[31]_i_12\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
...
\slv_reg0_buf5[31]_i_5\: unisim.vcomponents.LUT6
    generic map(
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix is
  ...
  signal \^out_test\ : STD_LOGIC_VECTOR ( 3 downto 1 );
...
begin
  out_test(3 downto 1) <= \^out_test\(3 downto 1);
  out_test(0) <= \<const0>\;
...
inst: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_coproct_v1_0
     port map (
      ...
      out_test(2 downto 0) => \^out_test\(3 downto 1),
      s00_axi_aclk => s00_axi_aclk,
