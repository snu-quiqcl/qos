...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_coproct_v1_0_S00_AXI is
  ...
  signal miniclk : STD_LOGIC;
  signal miniclk_i_1_n_0 : STD_LOGIC;
...
\counter1_carry__2\: unisim.vcomponents.CARRY4
     port map (
      ...
      CYINIT => '0',
      DI(3 downto 2) => B"00",
      DI(1) => \counter1_carry__2_i_1_n_0\,
      DI(0) => \counter1_carry__2_i_2_n_0\,
      O(3 downto 0) => \NLW_counter1_carry__2_O_UNCONNECTED\(3 downto 0),
      S(3) => \counter1_carry__2_i_3_n_0\,
      S(2) => \counter1_carry__2_i_4_n_0\,
      S(1) => \counter1_carry__2_i_5_n_0\,
      S(0) => \counter1_carry__2_i_6_n_0\
    );
...
miniclk_i_1: unisim.vcomponents.LUT2
    generic map(
      INIT => X"6"
    )
        port map (
...
miniclk_reg: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\out_buf[3]_i_1\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
