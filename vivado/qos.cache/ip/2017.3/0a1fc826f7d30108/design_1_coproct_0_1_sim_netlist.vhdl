...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_coproct_v1_0_S00_AXI is
  ...
  signal counter_reg : STD_LOGIC_VECTOR ( 31 downto 7 );
  ...
  signal \out_buf[3]_i_10_n_0\ : STD_LOGIC;
  signal \out_buf[3]_i_11_n_0\ : STD_LOGIC;
  signal \out_buf[3]_i_12_n_0\ : STD_LOGIC;
  ...
  signal \out_buf[3]_i_9_n_0\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \out_buf[3]_i_10\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \out_buf[3]_i_12\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \out_buf[3]_i_4\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \out_buf[3]_i_5\ : label is "soft_lutpair3";
...
\counter[0]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FFFFFFFF88A88888"
    )
        port map (
      I0 => counter_reg(26),
      I1 => counter_reg(25),
      I2 => \out_buf[3]_i_7_n_0\,
      I3 => \out_buf[3]_i_3_n_0\,
      I4 => counter_reg(24),
      I5 => \out_buf[3]_i_8_n_0\,
      O => clear
    );
...
\out_buf[3]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FFD0FFD0FFF0FFD0"
    )
        port map (
      I0 => counter_reg(19),
...
\out_buf[3]_i_10\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
      ...
      I2 => counter_reg(11),
      I3 => counter_reg(10),
      O => \out_buf[3]_i_10_n_0\
    );
\out_buf[3]_i_11\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"7F"
    )
        port map (
      ...
      I1 => counter_reg(14),
      I2 => counter_reg(13),
      O => \out_buf[3]_i_11_n_0\
    );
\out_buf[3]_i_12\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFFFFFE"
    )
        port map (
      ...
      I3 => counter_reg(9),
      I4 => counter_reg(12),
      O => \out_buf[3]_i_12_n_0\
    );
\out_buf[3]_i_2\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"000000005155FFFF"
    )
        port map (
      I0 => counter_reg(25),
      I1 => \out_buf[3]_i_7_n_0\,
      I2 => \out_buf[3]_i_3_n_0\,
      I3 => counter_reg(24),
      I4 => counter_reg(26),
      I5 => \out_buf[3]_i_8_n_0\,
      O => \out_buf[3]_i_2_n_0\
    );
\out_buf[3]_i_3\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"7FFF"
    )
        port map (
...
\out_buf[3]_i_4\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
      I0 => \out_buf[3]_i_9_n_0\,
      I1 => counter_reg(24),
      O => \out_buf[3]_i_4_n_0\
    );
\out_buf[3]_i_5\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
...
\out_buf[3]_i_6\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"55550155FFFFFFFF"
    )
        port map (
      I0 => counter_reg(16),
      I1 => counter_reg(7),
      I2 => \out_buf[3]_i_10_n_0\,
      I3 => counter_reg(12),
      I4 => \out_buf[3]_i_11_n_0\,
      I5 => counter_reg(17),
      O => \out_buf[3]_i_6_n_0\
    );
\out_buf[3]_i_7\: unisim.vcomponents.LUT6
    generic map(
      ...
      I1 => counter_reg(18),
      I2 => counter_reg(17),
      I3 => \out_buf[3]_i_12_n_0\,
      I4 => \out_buf[3]_i_11_n_0\,
      I5 => counter_reg(16),
      O => \out_buf[3]_i_7_n_0\
    );
\out_buf[3]_i_8\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFFFFFE"
    )
        port map (
...
\out_buf[3]_i_9\: unisim.vcomponents.LUT6
    generic map(
...
\out_buf_reg[0]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
        ...
        port map (
      C => s00_axi_aclk,
      CE => \out_buf[3]_i_2_n_0\,
      D => slv_reg0(0),
      Q => out_test(0),
      R => \out_buf[3]_i_1_n_0\
    );
