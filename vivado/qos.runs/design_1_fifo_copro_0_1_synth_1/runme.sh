...
HD_PWD='/home/seungwoo/Downloads/qos2/qos.runs/design_1_fifo_copro_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_fifo_copro_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_fifo_copro_0_1.tcl
