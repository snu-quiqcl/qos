...
HD_PWD='/home/seungwoo/Downloads/qos2/qos.tmp/coproc_v1_0_project/coproc_v1_0_project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log coproc_v1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source coproc_v1_0.tcl
