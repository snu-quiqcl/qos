...
HD_PWD='D:/verilog/qos2/coprocin/coprocin.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log coprocin.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source coprocin.tcl
