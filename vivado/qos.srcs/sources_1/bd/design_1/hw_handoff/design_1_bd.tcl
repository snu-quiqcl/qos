...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set out_test_0 [ create_bd_port -dir O -from 2 -to 0 out_test_0 ]
  set out_test_1 [ create_bd_port -dir O -from 2 -to 0 out_test_1 ]

  # Create instance: fifo_copro_0, and set properties
  set fifo_copro_0 [ create_bd_cell -type ip -vlnv user.org:user:fifo_copro:1.0 fifo_copro_0 ]

  # Create instance: fifo_copro_1, and set properties
  set fifo_copro_1 [ create_bd_cell -type ip -vlnv user.org:user:fifo_copro:1.0 fifo_copro_1 ]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins fifo_copro_0/S00_AXI] [get_bd_intf_pins ps7_0_axi_periph/M00_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M01_AXI [get_bd_intf_pins fifo_copro_1/S00_AXI] [get_bd_intf_pins ps7_0_axi_periph/M01_AXI]

  # Create port connections
  connect_bd_net -net fifo_copro_0_out_test [get_bd_ports out_test_0] [get_bd_pins fifo_copro_0/out_test]
  connect_bd_net -net fifo_copro_0_pitch_flag [get_bd_pins fifo_copro_0/pitch_flag] [get_bd_pins fifo_copro_1/catch_flag]
  connect_bd_net -net fifo_copro_1_out_test [get_bd_ports out_test_1] [get_bd_pins fifo_copro_1/out_test]
  connect_bd_net -net fifo_copro_1_pitch_flag [get_bd_pins fifo_copro_0/catch_flag] [get_bd_pins fifo_copro_1/pitch_flag]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins fifo_copro_0/s00_axi_aclk] [get_bd_pins fifo_copro_1/s00_axi_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_50M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_50M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_50M_interconnect_aresetn [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins rst_ps7_0_50M/interconnect_aresetn]
  connect_bd_net -net rst_ps7_0_50M_peripheral_aresetn [get_bd_pins fifo_copro_0/s00_axi_aresetn] [get_bd_pins fifo_copro_1/s00_axi_aresetn] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_50M/peripheral_aresetn]

  # Create address segments
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs fifo_copro_0/S00_AXI/S00_AXI_reg] SEG_fifo_copro_0_S00_AXI_reg
  create_bd_addr_seg -range 0x00010000 -offset 0x43C10000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs fifo_copro_1/S00_AXI/S00_AXI_reg] SEG_fifo_copro_1_S00_AXI_reg
